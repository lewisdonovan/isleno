-- /packages/supabase/migrations/20250128000011_fix_get_user_permissions_function.sql

-- Purpose: Fix the get_user_permissions function to properly cast enum types to text
...
-- Update the get_user_permissions function to cast enum types to text
